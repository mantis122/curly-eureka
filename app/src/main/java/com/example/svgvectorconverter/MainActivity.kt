...
class MainActivity : ComponentActivity() {
    ...
    private val saveH11CorpusProfileReport = registerForActivityResult(
        ...
        if (uri != null && currentH11CorpusProfileReport.isNotBlank()) {
            ...
            toast("H2.1 corpus profile saved")
        }
    }
    ...
    private fun showDeveloperToolsDialog() {
        ...
        val h11CorpusProfileButton =
            makeButton("Run H2.1 Size-Regression Attribution") {
        ...
        layout.addView(
            makeText(
                """
                Select a real-world SVG corpus. H2.1 runs each file through
    ...
    private fun runH11ProductionCorpusProfile(uris: List<Uri>) {
        ...
        val progressDialog = android.app.AlertDialog.Builder(this)
            .setTitle("H2.1 Size-Regression Attribution")
            .setView(progressLayout)
            .setCancelable(false)
            .create()
        ...
        Thread {
            ...
            val report = buildString {
                ...
                appendLine()
                appendLine(
                    "Total H2.1 wall time including input reads: " +
                        String.format(
                            java.util.Locale.US,
                            "%.2f ms",
    ...
    private fun showH11CorpusProfileResultsDialog(report: String) {
        ...
        val dialog = android.app.AlertDialog.Builder(this)
            .setTitle("H2.1 Size-Regression Results")
            .setView(layout)
            .setPositiveButton("Close", null)
            .create()
    ...
    private fun copyH11CorpusProfileReport() {
        if (currentH11CorpusProfileReport.isBlank()) {
            toast("No H2.1 corpus profile to copy")
            return
        }
        ...
        toast("H2.1 corpus profile copied")
    }
