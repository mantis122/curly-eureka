...
class MainActivity : ComponentActivity() {
    ...
    private val saveH11CorpusProfileReport = registerForActivityResult(
        ...
        if (uri != null && currentH11CorpusProfileReport.isNotBlank()) {
            ...
            toast("H2.4 corpus profile saved")
        }
    }
    ...
    private fun showDeveloperToolsDialog() {
        ...
        layout.addView(
            makeText(
                """
                Select a real-world SVG corpus. H2.4 runs each file through
    ...
    private fun runH11ProductionCorpusProfile(uris: List<Uri>) {
        ...
        Thread {
            ...
            val report = buildString {
                ...
                appendLine()
                appendLine(
                    "Total H2.4 wall time including input reads: " +
                        String.format(
                            java.util.Locale.US,
                            "%.2f ms",
    ...
    private fun copyH11CorpusProfileReport() {
        if (currentH11CorpusProfileReport.isBlank()) {
            toast("No H2.4 corpus profile to copy")
            return
        }
        ...
        toast("H2.4 corpus profile copied")
    }
