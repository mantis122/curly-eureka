...
object SvgToVectorConverter {
    fun convert(
        ...
        reportData.optimizationTransformUniformScalePostScaleOptimizationCalls = pathOptimizationStats.transformUniformScaleProfiling.postScaleOptimizationCalls
        reportData.optimizationTransformUniformScalePostScaleOptimizationUnchanged = pathOptimizationStats.transformUniformScaleProfiling.postScaleOptimizationUnchanged
        reportData.optimizationTransformUniformScalePostScaleRawChars = pathOptimizationStats.transformUniformScaleProfiling.postScaleRawChars
        reportData.optimizationTransformUniformScalePostScaleFinalChars = pathOptimizationStats.transformUniformScaleProfiling.postScaleFinalChars
        reportData.optimizationTransformUniformScalePostScaleSyntaxChanged = pathOptimizationStats.transformUniformScaleProfiling.postScaleSyntaxChanged
        reportData.optimizationTransformUniformScalePostScaleSyntaxCharsSaved = pathOptimizationStats.transformUniformScaleProfiling.postScaleSyntaxCharsSaved
        reportData.optimizationTransformUniformScalePostScaleRedundantGeometryChanged = pathOptimizationStats.transformUniformScaleProfiling.postScaleRedundantGeometryChanged
        reportData.optimizationTransformUniformScalePostScaleRedundantGeometryCharsSaved = pathOptimizationStats.transformUniformScaleProfiling.postScaleRedundantGeometryCharsSaved
        reportData.optimizationTransformUniformScalePostScaleArcChanged = pathOptimizationStats.transformUniformScaleProfiling.postScaleArcChanged
        reportData.optimizationTransformUniformScalePostScaleArcCharsSaved = pathOptimizationStats.transformUniformScaleProfiling.postScaleArcCharsSaved
        reportData.optimizationTransformUniformScalePostScaleCurveChanged = pathOptimizationStats.transformUniformScaleProfiling.postScaleCurveChanged
        reportData.optimizationTransformUniformScalePostScaleCurveCharsSaved = pathOptimizationStats.transformUniformScaleProfiling.postScaleCurveCharsSaved
        reportData.optimizationTransformUniformScalePostScaleCollinearChanged = pathOptimizationStats.transformUniformScaleProfiling.postScaleCollinearChanged
        reportData.optimizationTransformUniformScalePostScaleCollinearCharsSaved = pathOptimizationStats.transformUniformScaleProfiling.postScaleCollinearCharsSaved
        reportData.optimizationTransformUniformScalePostScaleCommandChanged = pathOptimizationStats.transformUniformScaleProfiling.postScaleCommandChanged
        ...
        reportData.optimizationTransformUniformScaleEarlySizeProfiledCandidates = pathOptimizationStats.transformUniformScaleProfiling.earlySizeProfiledCandidates
        reportData.optimizationTransformUniformScaleEarlySizeAcceptedCandidates = pathOptimizationStats.transformUniformScaleProfiling.earlySizeAcceptedCandidates
        reportData.optimizationTransformUniformScaleEarlySizeRejectedCandidates = pathOptimizationStats.transformUniformScaleProfiling.earlySizeRejectedCandidates
        reportData.optimizationTransformUniformScaleEarlySizeAcceptedTransformAttributeChars = pathOptimizationStats.transformUniformScaleProfiling.earlySizeAcceptedTransformAttributeChars
        reportData.optimizationTransformUniformScaleEarlySizeAcceptedFixedGroupMarkupChars = pathOptimizationStats.transformUniformScaleProfiling.earlySizeAcceptedFixedGroupMarkupChars
        reportData.optimizationTransformUniformScaleEarlySizeAcceptedPathCount = pathOptimizationStats.transformUniformScaleProfiling.earlySizeAcceptedPathCount
        reportData.optimizationTransformUniformScaleEarlySizeAcceptedOperandCount = pathOptimizationStats.transformUniformScaleProfiling.earlySizeAcceptedOperandCount
        reportData.optimizationTransformUniformScaleEarlySizeAcceptedPathDataChars = pathOptimizationStats.transformUniformScaleProfiling.earlySizeAcceptedPathDataChars
        reportData.optimizationTransformUniformScaleEarlySizeAcceptedStrokeWidthDeltaChars = pathOptimizationStats.transformUniformScaleProfiling.earlySizeAcceptedStrokeWidthDeltaChars
        reportData.optimizationTransformUniformScaleEarlySizeRejectedTransformAttributeChars = pathOptimizationStats.transformUniformScaleProfiling.earlySizeRejectedTransformAttributeChars
        reportData.optimizationTransformUniformScaleEarlySizeRejectedFixedGroupMarkupChars = pathOptimizationStats.transformUniformScaleProfiling.earlySizeRejectedFixedGroupMarkupChars
        reportData.optimizationTransformUniformScaleEarlySizeRejectedPathCount = pathOptimizationStats.transformUniformScaleProfiling.earlySizeRejectedPathCount
