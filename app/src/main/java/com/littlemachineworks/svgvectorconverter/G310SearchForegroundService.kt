...
class G310SearchForegroundService : Service() {
    ...
    companion object{
        const val ACTION_START="com.littlemachineworks.svgvectorconverter.G310_START";const val ACTION_RESTART="com.littlemachineworks.svgvectorconverter.G310_RESTART"
        const val ACTION_PAUSE="com.littlemachineworks.svgvectorconverter.G310_PAUSE";const val ACTION_RESUME="com.littlemachineworks.svgvectorconverter.G310_RESUME"
        const val ACTION_STOP="com.littlemachineworks.svgvectorconverter.G310_STOP";const val ACTION_DELETE_CHECKPOINT="com.littlemachineworks.svgvectorconverter.G310_DELETE_CHECKPOINT"
        const val ACTION_STATE_CHANGED="com.littlemachineworks.svgvectorconverter.G310_STATE_CHANGED";const val EXTRA_STATUS="status";const val EXTRA_COMPLETED="completed";const val EXTRA_TOTAL="total"
